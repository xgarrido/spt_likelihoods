...
class SPT3G_2018_TTTEEE_Ini_Foregrounds(HasLogger):
  ...
  def GalacticDust(self, pow_at_80, alpha, beta, nu1, nu2):
    ...
    Dl_galdust = Dl_galdust * DustFreqScaling(beta, self.T_galdust, self.nu_0_galdust, nu1) * DustFreqScaling(beta, self.T_galdust, self.nu_0_galdust, nu2)
  ...
  def tSZCIBCorrelation( self,
                         xi_tsz_CIB, tsz_pow_at_3000, CIB_pow_at_3000,
                         alpha, beta, zeta1, zeta2,
                         CIB_nu1, CIB_nu2, tSZ_nu1, tSZ_nu2,
                         cosmo=None):

    # Calculate CIB components
    Dl_cib_clustering_11 = self.CIBClustering(CIB_pow_at_3000, alpha, beta, CIB_nu1, CIB_nu1, zeta1, zeta1)
    Dl_cib_clustering_22 = self.CIBClustering(CIB_pow_at_3000, alpha, beta, CIB_nu2, CIB_nu2, zeta2, zeta2)
